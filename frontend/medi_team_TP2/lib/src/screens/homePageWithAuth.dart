...
class HomePageWithAuthState extends State<HomePageWithAuth> {
  ...
  Future<dynamic> getBackendDoctor() async {
    ...
    String url = auth.getIpAddress()+"/patients/$patientId";
  ...
  Future<dynamic> getBackendMedicalConsultations() async {
    ...
    String url =
      auth.getIpAddress()+"/medical-consultations?patient=$patientId&_sort=datetime:asc";
    http.Response response = await http.get(
      url,
      headers: {"Authorization": 'Bearer $token'},
    );
                          ...
                          child: Container(
                            ...
                            child: SizedBox(
                                ...
                                child: (patient == null ||
                                        patient['photo'] == null)
                                    ? Image(
                                        image: Image.network('https://medi-team.s3.amazonaws.com/patient.jpg').image,
                                        height: 80,
                                        width: 80,
                                      )
                                    : Image.network(
                                        auth.getIpAddress()+patient['photo']['url'],
                                      )),
                          )),
                      Flexible(
                          child: Column(
            ...
            countMedicalConsultations != 0
                ...
                : Container(
                    ...
                    child: Opacity(
                      ...
                      child: Image(
                          image:
                            Image.network('https://medi-team.s3.amazonaws.com/homepage_message.png').image,
                          width: double.infinity),
                    ),
                  ),
            Container(
                                    ...
                                    Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: SizedBox(
                                              ...
                                              height: 60,
                                              child: Image(
                                                image: Image.network('https://medi-team.s3.amazonaws.com/clock.jpg').image,
                                              )),
                                        )),
                                    Container(
                                        height: 60,
                                    ...
                                    Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: SizedBox(
                                            ...
                                            height: 60,
                                            child: Image.network(
                                              auth.getIpAddress()+medicalConsultations[index]['doctor']['photo']['url']
                                            )
                                          ),
                                        )),
                                    Container(
