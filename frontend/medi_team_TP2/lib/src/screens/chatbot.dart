...
class ChatbotState extends State<Chatbot> {
  ...
  Future<dynamic> getResponse() async {
    String url = auth.getIpAddress()+"/patients/chatbotAnswer";
          ...
          child: Stack(
            children: [
              Column(
                ...
                children: [
                  Image(
                    image: Image.network('https://medi-team.s3.amazonaws.com/chatbot_question.png').image,
                    width: double.infinity,
                  ),
                  question != ""
                      ? Container(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: Image.network('https://medi-team.s3.amazonaws.com/patient_color.jpg')),
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(4),
                                      border: Border.all(
                                          color:
                      ...
                      : Expanded(
                          child: Container(
                            ...
                            opacity: 0.25,
                            child: Image(
                              image: Image.network('https://medi-team.s3.amazonaws.com/question.png').image,
                            ),
                          )),
                        ),
                  answer != ""
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image.network('https://medi-team.s3.amazonaws.com/chatbot.jpg')),
                                      decoration: BoxDecoration(
                                          borderRadius:
