...
class BookallDataMedicalConsultationtate
  ...
  Future<dynamic> getBackendAllDataMedicalConsultation() async {
    ...
    String url =
        "http://10.0.2.2:1337/all-data-medical-consultation?timezoneOffsetMilliseconds=$timezoneOffsetMilliseconds";
  ...
  Widget build(BuildContext context) {
                          ...
                          child: Container(
                            ...
                            child: SizedBox(
                                ...
                                child: doctor['photo'] == null
                                    ...
                                    : Image.network("http://10.0.2.2:1337" +
                                        doctor['photo']['url'])),
                          )),
                      Container(
                          height: 50,
    ...
    Future<dynamic> getResponseBookMedicalConsultation() async {
      String url =
          "http://10.0.2.2:1337/medical-consultations/$medicalConsultationId";
